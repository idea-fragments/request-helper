...
var configureAuthedRequest = function (getAuthTokens, refreshTokenHeaderName) {
    return function (_a) {
        ...
        return (__assign(__assign({}, rest), { headers: __assign(__assign({}, headers), (_b = { Authorization: "Bearer ".concat(accessToken) }, _b[refreshHeader] = refreshToken, _b)), mode: "cors" }));
    };
};
...
var getSingleRecordData = function (data) {
    var _a;
    return __assign((_a = {}, _a[RECORD_TYPE_KEY] = data.type, _a.relationships = getRelationshipSnippet(data), _a), data.attributes);
};
var getRelationshipSnippet = function (data) {
    ...
    return Object.keys(data.relationships).reduce(function (relationships, k) {
        var _a;
        var _b, _c;
        var id = (_c = (_b = data.relationships[k].data) === null || _b === void 0 ? void 0 : _b.id) !== null && _c !== void 0 ? _c : null;
        return __assign(__assign({}, relationships), (_a = {}, _a[k] = { id: id }, _a));
    }, {});
};
...
var formatTimestamp = function () {
  ...
  var date = "".concat(now.getFullYear(), "-").concat(pad2(now.getMonth() + 1), "-").concat(pad2(now.getDate()));
  var time = "".concat(pad2(now.getHours()), ":").concat(pad2(now.getMinutes()), ":").concat(pad2(now.getSeconds()), ".").concat(pad3(now.getMilliseconds()), "000");
...
var Logger = /** @class */function () {
  function Logger(moduleName) {
    ...
    this.log = function (level) {
      return function () {
        ...
        var prefix = "".concat(formatTimestamp(), " ").concat(LEVEL_CODES[level], " ").concat(Logger.packagePrefix()).concat(_this.moduleName);
        console[level].apply(console, __spreadArray(["%c".concat(prefix), "".concat(LEVEL_STYLES[level], " padding: 2px 6px;")], __read(args), false));
        if (Logger.onLog) {
          try {
            Logger.onLog({
              args: args,
  ...
  Logger.removeModules = function (m) {
    m.forEach(function (name) {
      return modules.delete(name);
    });
  };
  Logger.clearModules = function () {
    modules.clear();
  };
...
var configureUnauthInterceptor = function (deleteAuthTokens, refreshRoute, refreshTokens, extraLogFields) {
    var lastRefreshCompletedAt = 0;
    return function (route, requestInitiatedAt) { return __awaiter(void 0, void 0, void 0, function () {
        var extra;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    extra = (_a = extraLogFields === null || extraLogFields === void 0 ? void 0 : extraLogFields()) !== null && _a !== void 0 ? _a : {};
                    if (!(route === refreshRoute)) return [3 /*break*/, 2];
                ...
                case 2:
                    if (requestInitiatedAt && lastRefreshCompletedAt > requestInitiatedAt) {
                        logger$4.writeInfo("[unauthInterceptor:skipRefresh]", __assign({ route: route }, extra));
                        return [2 /*return*/];
                    }
...
var logger$3 = new Logger_1("ensureAuthTokensRefreshed");
var ensureAuthTokensRefreshed = function (getAuthTokens, refreshRoute, refreshTokens, extraLogFields) {
    return function (uri) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, accessToken, isAccessTokenExpired, needToRefresh, extra;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _a = getAuthTokens(), accessToken = _a.accessToken, isAccessTokenExpired = _a.isAccessTokenExpired;
                    needToRefresh = uri !== refreshRoute
                        && !!accessToken
                        && isAccessTokenExpired();
                    if (!needToRefresh)
                        return [2 /*return*/, Promise.resolve()];
                    extra = (_b = extraLogFields === null || extraLogFields === void 0 ? void 0 : extraLogFields()) !== null && _b !== void 0 ? _b : {};
                    logger$3.writeInfo("[refreshQueue:waiting]", __assign({ uri: uri }, extra));
                    return [4 /*yield*/, refreshTokens()];
                case 1:
                    _c.sent();
                    logger$3.writeInfo("[refreshQueue:resumed]", __assign({ uri: uri }, extra));
                    return [2 /*return*/];
            }
        });
    }); };
...
var CONTENT_TYPE_METHOD_MAP = {
    "application/json": "json",
    "application/pdf": "blob",
};
var parseResponse = function (r) { return __awaiter(void 0, void 0, void 0, function () {
    var contentType, parseMethod;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                contentType = (_a = r.headers.get("content-type")) !== null && _a !== void 0 ? _a : "";
                contentType = (_b = Object.keys(CONTENT_TYPE_METHOD_MAP)
                    .find(function (k) { return (contentType).includes(k); })) !== null && _b !== void 0 ? _b : "";
                parseMethod = CONTENT_TYPE_METHOD_MAP[contentType];
                if (r.status === 204)
                    return [2 /*return*/, Promise.resolve(undefined)];
                if (!!parseMethod) return [3 /*break*/, 2];
                return [4 /*yield*/, r.text()];
            case 1: return [2 /*return*/, (_c.sent())];
            case 2:
                if (!(parseMethod === "json")) return [3 /*break*/, 4];
                return [4 /*yield*/, r.json()];
            case 3: return [2 /*return*/, _c.sent()];
            case 4: return [4 /*yield*/, r.blob()];
                ...
                return [4 /*yield*/, watchForErrors(errorInterceptor, function () { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    _b.sent();
                                    logger$2.writeInfo("[request:beforeHook:done]", __assign({ method: method, uri: uri }, extra));
                                ...
                                case 2:
                                    resp = _b.sent();
                                    status = resp.status;
                                    logger$2.writeInfo("[request:response]", __assign({ method: method, uri: uri, status: status }, extra));
                                ...
                                case 6:
                                    respBody = _b.sent();
                                    logger$2.writeInfo("[request:done]", __assign({ method: method, uri: uri, status: status }, extra));
...
var fetchConfig = function (method, intercept, body, query) {
    ...
    // @ts-ignore
    return __assign(__assign({}, config), { body: finalizeBody(config) });
};
var finalizeBody = function (_a) {
    var _b = _a.headers, headers = _b === void 0 ? {} : _b, body = _a.body;
    if (!body)
        return;
    // @ts-ignore
        ...
        switch (_a.label) {
            ...
            case 2:
                ...
                if (!(e_1 instanceof Error))
                    throw e_1;
                return [4 /*yield*/, errorInterceptor(e_1)];
            case 3:
                shouldNotBubble = _a.sent();
                if (shouldNotBubble)
                    return [2 /*return*/];
                throw e_1;
...
var Http = /** @class */ (function () {
    function Http(p) {
        ...
        this.makeRequest = function (_a) {
            ...
            return request(__assign(__assign(__assign({}, p), _this.config), { otherOptions: options, beforeRequestInterceptor: function (config) {
                    var _a;
...
var newRequestQueue = function (_a) {
    ...
    logger$1.writeInfo("[requestQueue:init]");
    var rtnPromise;
    var reset = function () {
        rtnPromise = undefined;
        logger$1.writeInfo("[requestQueue:done]");
    };
    return function (args) {
        logger$1.writeInfo("[requestQueue:enqueue]", { alreadyInFlight: !!rtnPromise });
        if (!rtnPromise) {
...
var transformParamsToSnakeCase = function (_a) {
    var body = _a.body, query = _a.query, rest = __rest(_a, ["body", "query"]);
    return (__assign(__assign({}, rest), { body: body ? snakecaseKeys(body) : undefined, query: query ? snakecaseKeys(query) : undefined }));
};
...
var newHttp = function (_a) {
    var afterRequestInterceptor = _a.afterRequestInterceptor, beforeRequestInterceptor = _a.beforeRequestInterceptor, deleteAuthTokens = _a.deleteAuthTokens, domain = _a.domain, extraLogFields = _a.extraLogFields, getAuthTokens = _a.getAuthTokens, processError = _a.processError, refreshRoute = _a.refreshRoute, refreshTokenHeaderName = _a.refreshTokenHeaderName, setAuthTokens = _a.setAuthTokens;
    logger.writeInfo("[newHttp:init]", __assign({ domain: domain }, extraLogFields === null || extraLogFields === void 0 ? void 0 : extraLogFields()));
    var http = new Http({
        ...
        beforeRequest: ensureAuthTokensRefreshed(getAuthTokens, refreshRoute, function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/, queueRequests({ http: http, refreshRoute: refreshRoute, setAuthTokens: setAuthTokens })];
        }); }); }, extraLogFields),
        beforeRequestInterceptor: lodash.exports.flow(configureAuthedRequest(getAuthTokens, refreshTokenHeaderName), beforeRequestInterceptor),
        domain: domain,
        extraLogFields: extraLogFields,
        errorInterceptor: processError,
        unauthInterceptor: configureUnauthInterceptor(deleteAuthTokens, refreshRoute, function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/, queueRequests({ http: http, refreshRoute: refreshRoute, setAuthTokens: setAuthTokens })];
        }); }); }, extraLogFields)
    });
    return http;
