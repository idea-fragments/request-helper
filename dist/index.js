...
var getRelationshipSnippet = function (data) {
    ...
    return Object.keys(data.relationships).reduce(function (relationships, k) {
        ...
        return _assign(_assign({}, relationships), (_a = {}, _a[k] = { id: id }, _a));
    }, {});
};
...
var ensureAuthTokensRefreshed = function (getAuthTokens, refreshRoute, refreshTokens) {
    return function (uri) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, accessToken, isAccessTokenExpired, needToRefresh;
        return __generator(this, function (_b) {
            ...
            return [2 /*return*/, needToRefresh ? refreshTokens() : Promise.resolve()];
        });
    }); };
};
...
var fetchConfig = function (method, intercept, body, query) {
    ...
    // @ts-ignore
    return _assign(_assign({}, config), { body: finalizeBody(config) });
};
...
var isObjectCustom = function isObjectCustom(value) {
  return isObject$1(value) && !(value instanceof RegExp) && !(value instanceof Error) && !(value instanceof Date);
};
...
mapObj$1.exports = function (object, mapper, options) {
...
var camelCase$1 = function camelCase(input, options) {
...
var map = mapObj$1.exports;
var snakeCase = require$$1.snakeCase;

var snakecaseKeys = function snakecaseKeys(obj, options) {
  options = Object.assign({
    deep: true,
    exclude: [],
    parsingOptions: {}
...
var transformParamsToSnakeCase = function (_a) {
    ...
    return (_assign(_assign({}, rest), { body: body ? snakecaseKeys(body) : undefined, query: query ? snakecaseKeys(query) : undefined }));
};
